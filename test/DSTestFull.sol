...
contract DSTestFull is PRBTest {
    ...
    function labelAndPrank(string memory name, uint256 deal) internal returns (address) {
    ...
    function _labelAndPrank(string memory name, uint256 deal) internal returns (address) {
